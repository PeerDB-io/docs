...
### peerdb_stats.peer_slot_size
A table providing information about your source PostgreSQL peer's replication slot. Among various fields, it periodically shows (updates) the replication slot size/lag as the difference of current LSN and flushed LSN.