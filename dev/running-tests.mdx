...
To setup postgres on a mac

1. Run `brew install postgresql` from the terminal
2. To start the server, `brew services start postgresql`
...
5. Following the [prerequisites](https://docs.peerdb.io/usecases/realtime-cdc#prerequisites) to setup real-time CDC using postgres, connect to postgres using psql CLI and run the below commands -
