...
2. **Transparent pricing:** Our pricing is based on compute usage rather than the amount of data transferred. Based on the volume of data you move, we will come up with the number of **cores and memory** needed for your use case. You will know that in advance and can scale up and down based on what you wish.
