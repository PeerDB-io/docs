---
title: "Real-time Streaming of Query results"
---

Below is a 5-minute tutorial to test [Real-time Streaming of Query results from Postgres to Snowflake](https://docs.peerdb.io/usecases/realtime-streaming-of-query-results)
...
### Step 1: CREATE Postgres and Snowflake Peers
    ...
    2. [Create Snowflake PEEER](https://docs.peerdb.io/sql/commands/create-peer#snowflake-peer)
