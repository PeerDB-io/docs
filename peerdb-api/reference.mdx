...
1. [Create a new CDC mirror](/peerdb-api/endpoints/create-mirror)
2. [Fetching mirror status](/peerdb-api/endpoints/mirror-status)
3. [Trigger a specified number of syncs](/peerdb-api/endpoints/custom-sync)
