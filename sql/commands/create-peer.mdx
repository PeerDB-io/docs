...
(
    url = 's3://<bucket>/<prefix-of-your-choice>'
);
```
In order to use this peer for streaming query replication, your AWS credentials must be filled in our PeerDB `docker-compose` file.
