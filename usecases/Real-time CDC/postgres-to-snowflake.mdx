...
If you prefere a UI, you can easily create a mirror using the PeerDB UI. Refer to the below video:
...
You can use the UI (localhost:3001) to monitor the status of the initial load. Refer to the below video:
<div style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
  <iframe
...
You can use the UI (localhost:3001) to monitor the status of the Change Data Capture (CDC). Refer to the below video:
<div style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
  <iframe
