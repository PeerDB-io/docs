---
title: "Real-time Streaming of Postgres to BigQuery"
---
...
WITH (
	...
	parallelism = 64,
	refresh_interval = 30,
	batch_duration_timestamp = 50000 // To be used when the watermark column is of type TIMESTAMP
);
```
...
```sql
-- drop the mirror
DROP MIRROR streaming_query_pg_to_bq;
```
