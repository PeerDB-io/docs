---
title: "Real-time Streaming of SQL Server to PostgreSQL"
---

### Step 1: CREATE SQL Server and PostgreSQL Peers
    1. [CREATE SQL Server PEER](https://docs.peerdb.io/sql/commands/create-peer#sqlserver-peer)
    2. [CREATE Postgres PEER](https://docs.peerdb.io/sql/commands/create-peer#postgresql-peer)
