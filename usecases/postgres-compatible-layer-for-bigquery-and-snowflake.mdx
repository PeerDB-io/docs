...
CREATE SERVER bigquery FOREIGN DATA WRAPPER postgres_fdw OPTIONS (host 'localhost', port '9900');
...
If you run into any issues, please file them on our gihub [repository](https://github.com/peerdb-io/peerdb) or reach out to founders@peerdb.io . We will follow up!
