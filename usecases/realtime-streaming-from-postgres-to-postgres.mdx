---
title: "Real-time Streaming of PostgreSQL to PostgreSQL"
---

### Step 1: CREATE Two Postgres Peers
    There is a guide available for creating a PostgreSQL peer here: [CREATE Postgres PEER](https://docs.peerdb.io/sql/commands/create-peer#postgresql-peer)
