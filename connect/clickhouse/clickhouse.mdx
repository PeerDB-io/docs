...
```
<Note>
When selecting the ReplicatedReplacingMergeTree/ReplicatedMergeTree table engine you need change [defaul settings](https://clickhouse.com/docs/operations/settings/settings#database_replicated_allow_replicated_engine_arguments).
```
<clickhouse>
  <profiles>
    <default>
