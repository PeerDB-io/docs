...
## Create MIRROR to start replicating data from Neon to ClickHouse

Once the Neon Peer is created, you can follow the steps in this [doc](/mirror/cdc-pg-clickhouse) to create the MIRROR for real-time Change Data Capture (CDC) from Neon to ClickHouse.
