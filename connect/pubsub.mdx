...
1. [Create a dedicated Service Account](https://cloud.google.com/iam/docs/keys-create-delete#iam-service-account-keys-create-console) for PeerDB through Google Cloud Console and specify `Pub/Sub Publisher`
    
   <Frame caption="Create a dedicated Service Account For PeerDB and grant the necessary permissions">
    <img src="/images/setup/pubsub-peerdb-ui.png" />
   </Frame>
